...
$sql = "INSERT INTO hubungi (nama, email, nomor_hp, alamat) VALUES ('$nama', '$email', '$nomor_hp', '$alamat')";
...
<body>
    <div class="container">
        ...
        <h1><?= $pesan ?></h1>
        <p>Terima kasih telah menghubungi Aroma Isuk. Kami akan segera merespons pesan Anda sambil menikmati secangkir kopi hangat.</p>
